...
float Renderer::getTF2DOpacity(float intensity, float gradientMagnitude) const
{
        ...
        double d1 = (intensity - m_config.TF2DIntensity) *
                (m_pGradientVolume->maxMagnitude()) - (gradientMagnitude) * (m_config.TF2DRadius);
        double d2 = (intensity - m_config.TF2DIntensity) *
                (m_pGradientVolume->maxMagnitude()) - (gradientMagnitude) * (-m_config.TF2DRadius);
